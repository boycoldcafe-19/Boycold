...
<body>
            ...
            <div class="orders-content">
                ...
                <div class="orders-header-row">
                    <div class="orders-heading">
                        ...
                        <p class="orders-subtitle">Manage and track all online and physical orders.</p>
                    </div>

                    <div class="orders-search-box">
                        <i class="fa-solid fa-magnifying-glass"></i>
                        <input type="text" id="orderSearch" placeholder="Search orders, customer or customer ID..">
                    </div>
                </div>

                <!-- Filter Tabs -->
                <div class="orders-filter-group" role="tablist">
                    <button type="button" class="order-filter-btn active" data-filter="all">
                        <i class="fa-solid fa-list-ul"></i>
                        <span>All Orders</span>
                    </button>
                    <button type="button" class="order-filter-btn" data-filter="Online">
                        <i class="fa-solid fa-desktop"></i>
                        <span>Online Order</span>
                    </button>
                    <button type="button" class="order-filter-btn" data-filter="Physical">
                        <i class="fa-solid fa-store"></i>
                        <span>Physical Order</span>
                    </button>
                </div>
                    ...
                    <div class="orders-table-wrapper">
                        <table class="orders-table">
                            ...
                            <tbody id="ordersTableBody">
                                <tr data-order-type="Physical" data-order-id="#ORDER-1234"
                                    data-customer="Alyssa Dionisio" data-time="May 30,2026 10:30 PM"
                                    data-total="₱135.00" data-payment="COD">
                                    <td class="order-id">#ORDER-0001</td>
                                    <td class="customer-name">Alyssa Dionisio</td>
                                    <td class="order-time">May 30,2026 10:30 PM</td>
                                    <td class="order-type">Physical</td>
                                    <td class="order-total">₱135.00</td>
                                    <td class="order-payment"><span class="payment-tag cod">COD</span></td>
                                    <td class="order-action">
                                        <button type="button" class="view-btn">View</button>
                                    </td>
                                </tr>
                                <tr data-order-type="Online" data-order-id="#ORDER-1234" data-customer="Alyssa Dionisio"
                                    data-time="May 30,2026 10:30 PM" data-total="₱135.00" data-payment="QRPh">
                                    <td class="order-id">#ORDER-0002</td>
                                    <td class="customer-name">Alyssa Dionisio</td>
                                    <td class="order-time">May 30,2026 10:30 PM</td>
                                    <td class="order-type">Online</td>
                                    <td class="order-total">₱135.00</td>
                                    <td class="order-payment"><span class="payment-tag qrph">QRPh</span></td>
                                    <td class="order-action">
                                        <button type="button" class="view-btn">View</button>
                                    </td>
                                </tr>
                                <tr data-order-type="Physical" data-order-id="#ORDER-1234"
                                    data-customer="Alyssa Dionisio" data-time="May 30,2026 10:30 PM"
                                    data-total="₱135.00" data-payment="COD">
                                    <td class="order-id">#ORDER-0003</td>
                                    <td class="customer-name">Alyssa Dionisio</td>
                                    <td class="order-time">May 30,2026 10:30 PM</td>
                                    <td class="order-type">Physical</td>
                                    <td class="order-total">₱135.00</td>
                                ...
                                <tr data-order-type="Online" data-order-id="#ORDER-1234" data-customer="Alyssa Dionisio"
                                    data-time="May 30,2026 10:30 PM" data-total="₱135.00" data-payment="QRPh">
                                    <td class="order-id">#ORDER-0004</td>
                                    <td class="customer-name">Alyssa Dionisio</td>
                                    <td class="order-time">May 30,2026 10:30 PM</td>
                                    <td class="order-type">Online</td>
                                    <td class="order-total">₱135.00</td>
                                ...
                                <tr data-order-type="Physical" data-order-id="#ORDER-1234"
                                    data-customer="Alyssa Dionisio" data-time="May 30,2026 10:30 PM"
                                    data-total="₱135.00" data-payment="COD">
                                    <td class="order-id">#ORDER-0005</td>
                                    <td class="customer-name">Alyssa Dionisio</td>
                                    <td class="order-time">May 30,2026 10:30 PM</td>
                                    <td class="order-type">Physical</td>
                                    <td class="order-total">₱135.00</td>
                                ...
                                <tr data-order-type="Online" data-order-id="#ORDER-1234" data-customer="Alyssa Dionisio"
                                    data-time="May 30,2026 10:30 PM" data-total="₱135.00" data-payment="QRPh">
                                    <td class="order-id">#ORDER-0006</td>
                                    <td class="customer-name">Alyssa Dionisio</td>
                                    <td class="order-time">May 30,2026 10:30 PM</td>
                                    <td class="order-type">Online</td>
                                    <td class="order-total">₱135.00</td>
                                ...
                                <tr data-order-type="Physical" data-order-id="#ORDER-1234"
                                    data-customer="Alyssa Dionisio" data-time="May 30,2026 10:30 PM"
                                    data-total="₱135.00" data-payment="COD">
                                    <td class="order-id">#ORDER-0007</td>
                                    <td class="customer-name">Alyssa Dionisio</td>
                                    <td class="order-time">May 30,2026 10:30 PM</td>
                                    <td class="order-type">Physical</td>
                                    <td class="order-total">₱135.00</td>
                                ...
                                <tr data-order-type="Online" data-order-id="#ORDER-1234" data-customer="Alyssa Dionisio"
                                    data-time="May 30,2026 10:30 PM" data-total="₱135.00" data-payment="QRPh">
                                    <td class="order-id">#ORDER-0008</td>
                                    <td class="customer-name">Alyssa Dionisio</td>
                                    <td class="order-time">May 30,2026 10:30 PM</td>
                                    <td class="order-type">Online</td>
                                    <td class="order-total">₱135.00</td>
                        ...
                        <div class="table-no-data" id="noOrdersMessage" style="display: none;">
    ...
    <!-- ORDER DETAILS / LONG PAPER THERMAL RECEIPT MODAL -->
    <div class="modal-overlay" id="orderModal" hidden>
        <div class="receipt-modal-container">
            ...
            <!-- Long Thermal Paper Roll Receipt -->
            <div class="receipt-paper" id="printableReceipt">
                ...
                <div class="receipt-meta">
                    ...
                    <div class="receipt-row">
                        ...
                        <span class="r-val" id="modalOrderTime">May 30, 2026 10:30 PM</span>
                    </div>
                    <div class="receipt-row">
                    ...
                    <div class="receipt-row">
                        ...
                        <span class="r-val bold" id="modalCustomerName">Alyssa Dionisio</span>
                    </div>
                    <div class="receipt-row">
                        <span class="r-label">ORDER TYPE:</span>
                        <span class="r-val bold" id="modalOrderType">ONLINE ORDER</span>
                    </div>
                    <div class="receipt-row">
                ...
                <div class="receipt-items-header">
                    ...
                    <span class="r-col-desc">ITEM / DESCRIPTION</span>
                ...
                <div class="receipt-totals">
                    ...
                    <div class="receipt-row">
                        ...
                        <span class="bold uppercase" id="modalPayment">COD</span>
                    </div>
                    ...
                    <div class="receipt-row" id="modalRefRow" style="display: none;">
                        ...
                        <span id="modalRefNo">GC-00000000</span>
                    </div>
                </div>
            ...
            <!-- Action Buttons below thermal paper -->
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            function filterOrders() {
                ...
                tableRows.forEach(row => {
                    ...
                    const customer = row.querySelector('.customer-name') ? row.querySelector('.customer-name').textContent.toLowerCase() : '';
                    const payment = row.querySelector('.order-payment') ? row.querySelector('.order-payment').textContent.toLowerCase() : '';

                    const matchesFilter = currentFilter === 'all' || orderType === currentFilter;
                    const matchesSearch = !query || orderId.includes(query) || customer.includes(query) || payment.includes(query) || orderType.toLowerCase().includes(query);
                ...
                if (noOrdersMessage) {
                    noOrdersMessage.style.display = visibleCount === 0 ? 'flex' : 'none';
                }
            }
            ...
            // Real-Time Thermal Receipt Modal Logic
            ...
            function renderDatabaseOrders(orders) {
                ...
                ordersTableBody.querySelectorAll('tr').forEach(row => {
                    row.dataset.items = JSON.stringify(orders[Number(row.dataset.itemsIndex)].items || []);
                    delete row.dataset.itemsIndex;
                });
                tableRows = ordersTableBody.querySelectorAll('tr');
                filterOrders();
            }

            fetch('admin_data_api.php?action=orders')
            ...
            function openReceiptModal(row) {
                const orderId = row.getAttribute('data-order-id') || '#ORDER-0000';
                const customer = row.getAttribute('data-customer') || 'Guest';
                ...
                items.forEach(item => {
                    ...
                    if (item.details && item.details.length > 0) {
                        detailsHTML = `<div class="receipt-item-details">` +
                            item.details.map(d => `<span class="r-indent">• ${d}</span>`).join('') +
                            `</div>`;
                    }
                    ...
                    itemBlock.innerHTML = `
                        <div class="receipt-item-main">
                            ...
                            <span class="r-col-amt">${itemTotal.toFixed(2)}</span>
                        </div>
                        ${detailsHTML}
                    `;
                ...
                // Real-Time Taxes & Totals
                const grandTotal = calculatedSubtotal;
                const vatableSales = grandTotal / 1.12;
                const vatAmount = grandTotal - vatableSales;

                document.getElementById('modalSubtotal').textContent = `₱${calculatedSubtotal.toFixed(2)}`;
                document.getElementById('modalVatSales').textContent = `₱${vatableSales.toFixed(2)}`;
                document.getElementById('modalVatAmt').textContent = `₱${vatAmount.toFixed(2)}`;
                ...
                if (payment.toLowerCase() === 'cod') {
                    const tenderedNum = !isNaN(tenderedAttr) ? tenderedAttr : Math.ceil(grandTotal / 50) * 50;
                    const changeNum = Math.max(0, tenderedNum - grandTotal);

                    document.getElementById('modalTendered').textContent = `₱${tenderedNum.toFixed(2)}`;
                    document.getElementById('modalChange').textContent = `₱${changeNum.toFixed(2)}`;
